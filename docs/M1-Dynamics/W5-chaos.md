...
<div class="flex-container">
  ...
  <ul class="reading-list">
    ...
    <li><span>📖</span> <a href="https://github.com/Vermont-Complex-Systems/MOCS-website/blob/main/docs/readings/Garfinkel-2017-ch5.pdf" target="_blank">Chaos (Ch.5 Garfinkel)</a></li>
  </ul>
</div>
</div>
